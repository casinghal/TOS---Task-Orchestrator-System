...
const uatStorageKey = "tos-tams-tkg-uat-v1";
...
export default function Home() {
  ...
  useEffect(() => {
    ...
    window.localStorage.setItem(uatStorageKey, JSON.stringify({ tasks: taskList, clients: clientList, team: teamList, activity, modules }));
  ...
  return <main className="flex min-h-screen items-center justify-center p-4">
    <section className="grid w-full max-w-5xl overflow-hidden rounded-xl border border-slate-200 bg-white shadow-xl md:grid-cols-[1.1fr_0.9fr]">
      <div className="bg-blue-700 p-8 text-white md:p-10">
        ...
        <h1 className="mt-8 max-w-lg text-3xl font-semibold leading-tight md:text-4xl">TAMS-TKG UAT workspace: simple work tracking, disciplined review, owner control.</h1>
        <p className="mt-4 max-w-xl text-sm leading-6 text-blue-100">This first UAT build is intentionally simple for CA team usage. Changes persist in this browser during UAT, while Supabase persistence is the next deployment layer.</p>
      ...
      <div className="p-6 md:p-8">
        <p className="text-xs font-semibold uppercase text-blue-700">Demo login</p>
        <h2 className="mt-2 text-2xl font-semibold text-slate-950">Choose a role</h2>
        <p className="mt-2 text-sm text-slate-500">Use safe UAT demo users to test permissions without real client data.</p>
